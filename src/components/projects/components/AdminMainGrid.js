...
import AdminCustomizedDataGrid from "./AdminCustomizedDataGrid";
...
export default function AdminProjectsGrid() {
  ...
  return (
    <Box sx={{ width: "100%", maxWidth: { sm: "100%", md: "1700px" } }}>
      ...
      <Grid container spacing={2}>
        <Grid item md={12}>
          <AdminAddressForm onSuccess={handleFormSuccess}/>
        </Grid>
        {/* <Grid item xs={4}> */}

...
function AreaGradient({ color, id }:any) {
  return (
    <defs>
...
export default function SessionsChart() {
  ...
  const colorPalette = ["#6941C6", "#5535a1", "#4b2e8f"];
  ...
  return (
    <Card variant="outlined" sx={{ width: "100%" }}>
      <CardContent>
        ...
        >
          <AreaGradient color="#4b2e8f" id="organic" />
          <AreaGradient color="#5535a1" id="referral" />
          <AreaGradient color="#6941C6" id="direct" />
        </LineChart>
      </CardContent>
    </Card>
  );

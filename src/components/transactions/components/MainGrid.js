  ...
  return (
    <Box sx={{ width: "100%", maxWidth: { sm: "100%", md: "1700px" } }}>
      ...
      <Typography variant="body1" sx={{ mb: 3, color: "gray" }}>
        Please fill in your transaction details here for freelancing data.
      </Typography>
      ...
      {/* New line added here */}
      <Typography variant="body1" sx={{ mb: 3, color: "gray" }}>
        Here you will find your project transactions of freelancing data.
      </Typography>
      <Grid container spacing={2}>
        <Grid item md={12} lg={12}>
          <p className=' bg-gray'>We are currently working on this</p>
        {/* <CustomizedDataGrid
